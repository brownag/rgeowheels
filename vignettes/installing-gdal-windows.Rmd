...
# By default, don't execute chunks (they require manual setup and Windows)
...
```{r detect-envs, eval = requireNamespace("rgeowheels", quietly = TRUE) && is_windows}
library(rgeowheels)
...
```{r list-versions, eval = requireNamespace("rgeowheels", quietly = TRUE) && is_windows}
